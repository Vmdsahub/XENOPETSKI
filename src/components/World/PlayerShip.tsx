...
export const PlayerShip: React.FC<PlayerShipProps> = ({ rotation }) => {
  return (
    <motion.div
    ...
    >
      ...
      />
      <motion.div
        className="absolute w-0.5 h-3 bg-gradient-to-t from-transparent to-cyan-300 transform -translate-x-1/2"
        style={{
          top: "calc(100% - 6px)",
          left: "50%",
          zIndex: -1,
